package com.soundhub.presentation.pages.music.ui.dialog
...
import com.soundhub.presentation.pages.music.ui.dialog.components.AuthorizedMusicServiceDialog
import com.soundhub.presentation.pages.music.ui.dialog.components.UnauthorizedMusicServiceDialog
	...
	Dialog(
		...
		Box(
			...
			Card(
				modifier = Modifier
					.fillMaxWidth()
					.defaultMinSize(minHeight = MusicDialogConfig.DIALOG_MIN_HEIGHT)
			) {
				Column {
					Row(
