...
import com.soundhub.ui.music.components.RecommendationPlate
...
fun RecommendationSection() {
    val plates = listOf(
        ...
        RecommendationPlateData(
            ...
            gradientColor = Brush.linearGradient(listOf(
                Color(0xFF51DD4F), Color(red = 0.309f, green = 0.86f, blue = 0.73f, alpha = 0.5f)
            )),
